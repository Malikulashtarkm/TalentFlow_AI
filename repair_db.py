...
def repair():
    try:
        ...
        schema_commands = [
            "CREATE TABLE IF NOT EXISTS candidates (candidate_id UUID PRIMARY KEY DEFAULT gen_random_uuid(), email TEXT UNIQUE NOT NULL, first_name TEXT NOT NULL, last_name TEXT NOT NULL, phone_number TEXT, city TEXT, state TEXT, country TEXT, password TEXT, expected_salary NUMERIC, created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW());",
        ...
        print("Repairing missing tables...")
        ...
        conn.commit()
        print("Database repair complete. All tables and analytics schema verified.")
